...
def main():
    ...
    <body>
    <p>Congratulations! You are now successfully subscribed to Sachin's project for disaster monitoring. Thank you for choosing to stay informed and prepared in times of crisis.</p>
    ...
    if st.button("Subscribe to Alerts"):
        ...
        if st.session_state.username == '':
            ...
            subscriptions_collection = subscriptions_db["disaster_info"]
            subscription_data = {
